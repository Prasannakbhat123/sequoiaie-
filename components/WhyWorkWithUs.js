    ...
    <div className="header__cards__container">
          ...
          <div className="card" style={{ backgroundImage: 'url(/img/cardbg2.jpg)' }}>
            <div className="card__content">
              ...
              <p>A transparent, client-first approach to interior design with no advance payments. We work as consultants who collaborate with you, putting you in control of your project both creatively and financially.</p>
