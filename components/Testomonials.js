    ...
    <div className="testomonials">
      ...
      <div className="all__testomonials">
        ...
        <div className="testomonial">
          ...
          <span>
            <span className="large__font">"</span> The transparency in Sequoiaie's interior design process is refreshing. No advance payments and complete control over our budget made the entire renovation stress-free. We could track every expense in real-time, and the results exceeded our expectations. Highly recommended! <span className="large__font">"</span>
          </span>
        </div>
        <div className="testomonial">
          <div className="user__data">
